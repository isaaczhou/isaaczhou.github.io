  ...
  })(
    {
        ...
        function(e, t, r) {
          ...
          h.prototype.parseImplicitGroup = function() {
            ...
            if (t === "\\left") {
              ...
              return new c(
                "sizing",
                {size: "size" + (l.indexOf(d, t) + 1), value: r},
                this.mode
              );
          ...
          h.prototype.parseSymbol = function() {
            ...
            if (a[e.text]) {
              ...
              this.consume();
              return new m(
                new c(s[this.mode][e.text].group, e.text, this.mode, e),
                false,
                e
              );
        ...
        function(e, t, r) {
          ...
          w.supsub = function(e, t) {
            ...
            if (!e.value.sup) {
              v = Math.max(
                v,
                c.metrics.sub1,
                h.height - 0.8 * c.metrics.xHeight
              );
          ...
          w.spacing = function(e, t) {
            if (
              ...
              return p(
                ["mspace", n.spacingFunctions[e.value].className],
                [],
                t
              );
            }
          ...
          w.op = function(e, t) {
            ...
            if (e.value.symbol) {
              ...
              m = n.makeSymbol(e.value.body, g, "math", t, [
                "mop",
                "op-symbol",
                c ? "large-op" : "small-op"
              ]);
              f =
                (m.height - m.depth) / 2 -
                l.metrics.axisHeight * l.sizeMultiplier;
              d = m.italic;
            ...
            if (s) {
              ...
              if (r) {
                ...
                k = Math.max(
                  ...
                  o.metrics.bigOpSpacing3 - A.depth
                );
              }
              if (a) {
                T = t.withStyle(l.sub());
                ...
                M = Math.max(
                  ...
                  o.metrics.bigOpSpacing4 - N.height
                );
              }
              var q;
              var R;
          ...
          w.sqrt = function(e, t) {
            ...
            var v = p(
              ["sqrt-sign"],
              [s.customSizedDelim("\\surd", f, false, t, e.mode)],
              t
            );
      ...
      14: [
        function(e, t, r) {
          ...
          var c = function(e, t, r, a) {
            a = a || [];
            var i = u(
              a.concat(["style-wrap", r.style.reset(), t.cls()]),
              [e],
              r
            );
      ...
      19: [
        function(e, t, r) {
          ...
          l(["\\kern", "\\mkern"], {numArgs: 1, argTypes: ["size"]}, function(
            e,
            t
          ) {
          ...
          l(["\\int", "\\iint", "\\iiint", "\\oint"], {numArgs: 0}, function(
            e
          ) {
          ...
          l(["\\llap", "\\rlap"], {numArgs: 1, allowedInText: true}, function(
            e,
            t
          ) {
            var r = t[0];
          ...
          l(["\\begin", "\\end"], {numArgs: 1, argTypes: ["text"]}, function(
            e,
            t
          ) {
            var r = t[0];
